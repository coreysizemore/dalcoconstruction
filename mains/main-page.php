		...
		if( get_field('product') ):
			...
			if( have_rows('product_content') ):
				...
				while ( have_rows('product_content') ) : the_row();
					...
					the_sub_field('product_url');
					
					echo '"><div class="filter"><span class="icon icon-expand"></span></div><img src="';
					
					the_sub_field('product_image');
						
					echo '" alt="product category selection image" /></a><span class="gallery_title">';
